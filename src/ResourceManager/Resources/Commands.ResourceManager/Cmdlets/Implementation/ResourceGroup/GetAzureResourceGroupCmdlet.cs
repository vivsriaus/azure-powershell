...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    public class GetAzureResourceGroupCmdlet : ResourceManagerCmdletBase
    {
        ...
        /// </summary>
        [Alias("ResourceId", "ResourceGroupId")]
        ...
        private void RunCmdlet()
        {
            PaginatedResponseHelper.ForEach(
                ...
                action: resources => this.WriteObject(sendToPipeline: resources.CoalesceEnumerable().SelectArray(resource => resource.ToResource().ToPsObject()), enumerateCollection: true));
        }
